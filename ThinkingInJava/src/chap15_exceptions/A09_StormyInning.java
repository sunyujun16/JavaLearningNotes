...
public class A09_StormyInning extends Inning implements Storm {
    // OK to add new exceptions for constructors, but you
    // must deal with the base constructor exceptions:
    public A09_StormyInning() throws RainedOut, BaseballException {
    }

    public A09_StormyInning(String s)
    ...
    public static void main(String[] args) {
        try {
            A09_StormyInning si = new A09_StormyInning();
            si.atBat();
        } catch (PopFoul e) {
